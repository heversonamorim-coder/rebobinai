...
export const PLANS_FALLBACK: Plan[] = [
  ...
  },
  {
    ...
    launchPrice: 2990,
    launchEndsAt: null,
    features: ['Tudo do Digital', 'Vitalício', 'IA compositor', 'Analytics de aberturas', 'Mais fotos'],
    active: true,
    sortOrder: 2,
  },
  {
    ...
    key: 'quadro',
    name: '+ Quadro',
    tagline: 'O presente na parede',
    fullPrice: 14900,
    launchPrice: 11900,
    launchEndsAt: null,
    features: ['Tudo do Pra Sempre', 'Quadro impresso com QR', 'Frete à parte'],
    active: true,
    sortOrder: 3,
  },
];
